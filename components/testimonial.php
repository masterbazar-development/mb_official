<section id="testimonial" class="py-20">
    <div class="text-center">
        <div class="text-[#6E95FF] text-2xl font-bold mb-2">
            <h2>Our Happy Client</h2>
        </div>
        <div class="text-white sm:text-5xl sm:text-4xl text-3xl font-bold">
    ...
    ?>  
        ...
        <div class="swiper-pagination -translate-y-6"></div>
    </div>
