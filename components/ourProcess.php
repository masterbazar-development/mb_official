...
<h3 class="2xl:w-full xl:max-w-7xl mx-auto 2xl:text-6xl md:text-5xl text-4xl backdrop-blur-md py-10 text-[#172554] text-start font-extrabold md:mt-40 sm:mt-20 mt-10 md:mb-48 sm:mb-20 mb-10">Our <span class="text-blue"> creative digital agency </span> designs and develops bespoke websites with <span class="text-blue"> three things in mind. </span></h3>
