    ...
    <div class="lg:w-2/3 sm:w-1/2 w-full overflow-y-auto h-full 2xl:px-20  px-6 lg:py-0 py-8 sm:px-8  bg-[#DAE5FC] text-head flex lg:justify-center justify-start items-start flex-col">
        <div class="flex lg:flex-row flex-col lg:justify-between justify-start items-start w-full xl:gap-8 lg:gap-2 gap-4">
            ...
            <nav class="2xl:text-5xl lg:text-4xl md:text-3xl text-2xl font-extrabold flex justify-start items-start 2xl:gap-4 md:gap-2 flex-col ">
                <a class="halo" href="<?php echo $mainUrl; ?>">Home</a>
                <a class="halo" href="<?php echo $mainUrl; ?>aboutus" class="text-blue">About Us</a>
                <a class="halo" href="<?php echo $mainUrl; ?>career">Career</a>
                <a class="halo" href="<?php echo $mainUrl; ?>blog">Blog</a>
                <a class="halo" href="<?php echo $mainUrl; ?>contactus">Contact Us</a>
            ...
            <nav class="2xl:text-2xl text-xl font-medium flex justify-start items-start flex-col ">
                <h3 class="2xl:text-4xl lg:text-3xl text-2xl xl:mb-4 mb-2 text-blue font-extrabold">Quick Links</h3>
                <a href="<?php echo $mainUrl; ?>terms" class="2xl:text-xl text-lg font-bold">Terms and Conditions</a>
                <a href="<?php echo $mainUrl; ?>privacy" class="2xl:text-xl text-lg font-bold">Privacy and Policy</a>
            </nav>
        </div>
    </div>
    </div>

    <div class="nav-part lg:w-1/3 sm:w-1/2 w-full h-full  flex justify-center items-start gap-16 flex-col lg:px-10 px-6 sm:py-0 py-12">
        <div class="text-white">
            <div class="text-xl font-semibold text-gray-200">Got An Idea?</div>
            <div class="xl:text-4xl text-3xl mt-2 xl:mb-3 mb-2 font-extrabold">Let's Start Building the Projects!</div>
            <p class="font-light text-lg font-livvic">Kickstart your project journey with a single click: Start Project and dive into the world of possibilities and innovation!</p>
            <button class="bg-gradient-to-br from-[#2563EB33] to-[#7DA5FB33] py-3 px-10 mt-8 shadow rounded-full tracking-wider font-medium flex justify-center items-center gap-4">
                <span>Start Project</span>
                <span><i class="fa-solid fa-play"></i></span>
            </button>
        </div>

        <div class="text-gray-200 font-livvic">
