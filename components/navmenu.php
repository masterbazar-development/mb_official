<section class="navigation sm:h-screen h-full transition-all duration-700 w-full z-[90] fixed top-0 left-0 -translate-y-[100%] flex justify-start items-start sm:flex-row flex-col">
    <div class="lg:w-2/3 w-full overflow-y-auto h-full 2xl:px-20 lg:py-0 pt-8   bg-[#DAE5FC] text-head flex lg:justify-center justify-start items-start flex-col">
        <div class="flex mt-6 lg:mt-0 lg:flex-row flex-col lg:justify-between justify-start items-start w-full xl:gap-8 lg:gap-2 gap-4 px-6 ">
            ...
            <nav class="2xl:text-5xl lg:text-4xl md:text-3xl text-2xl font-extrabold flex justify-start items-start 2xl:gap-4 md:gap-2 flex-col mt-10 lg:mt-0">
                ...
                <div class="hidden lg:block">
                    <h3 class="text-head font-extrabold text-2xl lg:mt-10">Social Links</h3>
            ...
            <nav class="2xl:text-2xl text-xl font-medium flex justify-start items-start flex-col ">
                ...
                <a href="<?php echo $mainUrl; ?>terms" class=" 2xl:text-xl text-lg font-bold halo">Terms and Conditions</a>
                <a href="<?php echo $mainUrl; ?>privacy" class=" 2xl:text-xl text-lg font-bold halo">Privacy and Policy</a>
        ...
        <div class="nav-part mt-10 sm:block md:hidden  w-full md:h-full  flex justify-center items-start gap-8 flex-col lg:px-10 px-6 sm:py-0 py-12">
    ...
    <div class="hidden nav-part lg:w-1/3  w-full md:h-full  md:flex justify-center items-start gap-16 flex-col lg:px-10 px-6 sm:py-0 py-12">
        <div class="text-white">
            <div class="text-xl font-semibold text-gray-200">Got An Idea?</div>
            <div class="xl:text-4xl text-xl md:text-3xl mt-2 xl:mb-3 mb-2 font-extrabold">Let's Start Building the Projects!</div>
            <p class=" font-light text-lg font-livvic">Kickstart your project journey with a single click: Start Project and dive into the world of possibilities and innovation!</p>
