    ...
    <div class="mx-6 py-12 text-center flex justify-center md:text-left">
        <div class=" mx-[2vw] 2xl:mx-[10vw]">
            <div class="grid-1 grid gap-4 lg:gap-32 md:grid-cols-3">
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-2 flex gap-5 justify-center md:justify-start text-blue">
                        <a href="https://www.instagram.com/themasterbazar?igshid=YmMyMTA2M2Y=" class="">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-[#264CC5] hover:fill-[#264CC5] hover:scale-110 transition ease-in-out delay-150 hover:-translate-y-1  duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="md:ml-[-2rem] lg:ml-[0rem]">
                    <h6 class="md:mb-8 mb-3 text-3xl flex text-head justify-center font-extrabold uppercase md:justify-start">
                        Contact Us
                    </h6>
