<div id="client-logo" class="image-container bg-black flex justify-center items-center sm:flex-nowrap flex-wrap md:gap-12 sm:gap-8 gap-4 sm:py-12 py-8">
    <div class="image-box bg-black relative xl:xl:w-[150px] xl:xl:h-[150px] w-[100px] h-[100px]overflow-hidden">
        <img src="<?php echo $mainUrl?>assets/client/images/testimonial/cl4.svg" alt="Image 1" class="image image1">
        <img src="<?php echo $mainUrl?>assets/client/images/testimonial/cl1.svg" alt="Image 2" class="image image2">
        <img src="<?php echo $mainUrl?>assets/client/images/testimonial/cl2.svg" alt="Image 3" class="image image3">
        <img src="<?php echo $mainUrl?>assets/client/images/testimonial/cl3.svg" alt="Image 4" class="image image4">
    </div>
