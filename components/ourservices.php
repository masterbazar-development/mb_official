<section class="2xl:max-w-full xl:max-w-7xl 2xl:mx-[10vw] mx-auto px-4 sm:py-32 py-16 gap-8">
    ...
    <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 lg:gap-8 gap-4 max-w-6xl mx-auto md:mt-15 mt-12">
        <div class="bg-gradient-to-br from-[#2563EB33] to-[#7DA5FB33] text-gray-800 px-4 py-6 services-effect">
            <div class="relative w-max">
                ...
                <img src="<?php echo $mainUrl ?>/assets/client/images/designing-home.png" class="w-14 mb-4 absolute  text-blue top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            </div>
            <h3 class="text-2xl text-head font-bold mb-1 ">Designing</h3>
        ...
        <div class="bg-gray-100 text-gray-800 px-4 py-6 services-effect">
            <div class="relative w-max">
                <img src="<?php echo $mainUrl ?>/assets/client/images/ellipse.png" class="w-16 mb-4">
                <img src="<?php echo $mainUrl ?>/assets/client/images/sales-and-support-home.png" class="w-14 mb-4 absolute  text-blue top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            </div>
            <h3 class="text-2xl text-head font-bold mb-1">Sales and Support</h3>
            <p class="font-livvic">Lorem ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio. ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio.</p>
        ...
        <div class="bg-gradient-to-br from-[#2563EB33] to-[#7DA5FB33] text-gray-800 px-4 py-6 services-effect ">
            <div class="relative w-max">
                <img src="<?php echo $mainUrl ?>/assets/client/images/ellipse.png" class="w-16 mb-4">
                <img src="<?php echo $mainUrl ?>/assets/client/images/development-home.png" class="w-14 mb-4 absolute  text-blue top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            </div>
            <h3 class="text-2xl text-head font-bold mb-1">Development</h3>
            <p class="font-livvic">Lorem ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio. ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio.</p>
            <button class="text-head px-6 py-2 mt-4 rounded-md bg-white text-sm font-bold">Read More</button>
        </div>
        ...
        <div class="bg-gray-100 text-gray-800 px-4 py-6 rounded-lg s services-effect ">
            ...
            <h3 class="text-2xl text-head font-bold mb-1">Content Writing</h3>
            <p class="font-livvic">Lorem ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio. ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio.</p>
            <button class="text-head px-6 py-2 mt-4 rounded-md bg-gray-200 text-sm font-bold">Read More</button>
        </div>
        ...
        <div class="bg-gradient-to-br from-[#2563EB33] to-[#7DA5FB33] text-gray-800 px-4 py-6 services-effect">
            <div class="relative w-max">
                <img src="<?php echo $mainUrl ?>/assets/client/images/ellipse.png" class="w-16 mb-4">
                <img src="<?php echo $mainUrl ?>/assets/client/images/digital-home.png" class="w-14 mb-4 absolute  text-blue top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            </div>
            <h3 class="text-2xl text-head font-bold mb-1">Digital Marketing</h3>
            <p class="font-livvic">Lorem ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio. ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio.</p>
            <button class="text-head px-6 py-2 mt-4 rounded-md bg-white text-sm font-bold">Read More</button>
        </div>
        ...
        <div class="bg-gray-100 text-gray-800 px-4 py-6 services-effect">
            <div class="relative w-max">
                <img src="<?php echo $mainUrl ?>/assets/client/images/ellipse.png" class="w-16 mb-4">
                <img src="<?php echo $mainUrl ?>/assets/client/images/online-reputation-home.png" class="w-14 mb-4 absolute  text-blue top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            </div>
            <h3 class="text-2xl text-head font-bold mb-1">Online Reputation</h3>
            <p class="font-livvic">Lorem ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio. ipsum dolor sit amet consectetur adipisicing elit Nulla aliquid omnis debitis odio.</p>
            <button class="text-head px-6 py-2 mt-4 rounded-md bg-gray-200 text-sm font-bold">Read More</button>
        </div>
    </div>
