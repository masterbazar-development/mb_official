...
<div class=" p-3 md:p-8 mt-10 lg:mt-0 bg-[#DAE5FC]">
    <h6 class="text-head text-2xl font-bold"><span class="border-t-2  border-blue">About</span> US</h6>
    <p class=" text-gray-700 text-md pt-4 font-livvic">Our blog is your go-to source for staying on top of the latest developments in digital marketing, web & development, and more. Get insights, analysis, and advice from our experts. Here we share valuable insights, tips, and strategies to help businesses excel in their sales and support efforts. </p>
</div>
<div class="sticky top-0">
    ...
    <div class="p-3 md:p-8 mt-6  bg-slate-200">
        ...
        <p class=" text-gray-800 font-semibold text-center py-3 font-livvic">Subscribe to recieve inspiration, ideas, and news in your inbox.</p>
        <form method="post" action="../newsletter/subscribers.php" enctype="multipart/form-data">
            <div class="flex justify-start items-center flex-col sm:flex-row gap-3 sm:gap-6  md:gap-12 my-4 md:my-6 trigger4">
                ...
                <div class="w-max">
                    <button name="submit-btn" value="submit" class="bg-blue  button2 text-white rounded-sm text-base xl:text-lg font-normal hover:font-normal py-1 px-3 xl:px-3  hover:scale-[1.05] hover:ease-linear hover:duration-100 transition-all">
                        Submit
                    </button>
                </div>
            </div>
