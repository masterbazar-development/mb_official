    ...
    <div class="lg:w-2/3 px-3 lg:px-0">
        <div class="scroll-par flex items-center my-6">
            ...
            <div class="webdev my-auto items-center w-full p-8 ml-8 bg-gradient-to-r from-[#2563EB33] to-[#7DA5FB33]">
                ...
                <p class="text-sm lg:text-lg font-livvic font-light mt-1">Softwares are the backbone of smooth operations in any organization. We help make your business operations more efficient and increase overall productivity with our custom software solutions that solve your specific problems.</p>
            </div>
        </div>
