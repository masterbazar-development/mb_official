    ...
    <div class="max-w-full  ">
        ...
        <div class="flex flex-col items-center mt-10 lg:mt-32 lg:flex-row max-w-full mx-[5vw] gap-8 lg:gap-20 md:mx-[10vw] ">
            ...
            <div class="lg:w-1/2 order-1 lg:order-2">
                <img src="<?php echo $mainUrl; ?>assets/client/images/seoban.png" alt="" class="w-full pt-14">
            </div>
        </div>
...
<section class="hidden lg:flex gap-12 xl:gap-20 max-w-full mx-[5vw] md:mx-[10vw] mt-32">
    ...
    <div class="w-[40%] ">
        <img src="<?php echo $mainUrl; ?>assets/client/images/seo1.jpg" alt="" class="w-full">
    </div>
</section>
...
<section class="lg:flex gap-20 max-w-full mx-[5vw] md:mx-[10vw] mt-20 md:mt-32">
    <div class="lg:w-[40%]">
        <img src="<?php echo $mainUrl; ?>assets/client/images/seo2.jpg" alt="" class="w-full">
    </div>
...
<section class="max-w-full mx-[5vw] md:mx-[10vw] my-32 gap-8">
    <div class="">
        <h3 class="md:text-5xl text-4xl text-head font-extrabold sm:mb-4 mb-2">SEO Services for Your <span class="text-[#264CC5] font-extrabold">Website's Success</span></h3>
    ...
    <div class="max-w-7xl grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 lg:gap-8 gap-4 mx-auto md:mt-10 mt-12">
        <div class="bg-gradient-to-br from-[#2563EB33] to-[#7DA5FB33] text-gray-800 px-4 py-6 rounded-lg shadow-xl transition duration-300 ease-in-out hover:scale-110">
            ...
            <div class="flex-col justify-between">
                ...
                <p class="font-livvic">With thorough market analysis, we find the most relevant and high-performing keywords for your website. We prepare effective keyword strategy that matches your goals, and audience and beat your competition.</p>
            </div>
        </div>
