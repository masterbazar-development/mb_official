    ...
    <?php include('message.php'); ?>
        <div class="card">
            ...
            <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($posts_run) > 0)
                                    {
                                        foreach ($posts_run as $postItem) {  
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../images/blog/<?=$postItem['image']?>" width="70px" height="70px" alt=""></td>
                                                <td>
                                                    
                                                    <?= $postItem['status'] == '1' ? 'Hidden': 'Visible' ?></td>
                                                    
                                                     <td>
                                                    <a href="preview-post.php?title=<?= $postItem['slug'] ?>" target="_blank" class="btn btn-success">Preview</a>
                                                </td>
                                                    
                                                <td>
                                                    <a href="post-edit.php?id=<?= $postItem['id'] ?>" class="btn btn-success">Edit</a>
                                                </td>
                    ...
                    <a href="post-view.php?page=<?= $i ?>" class="page-link"><?= $i ?></a></li>
                        <?php } ?>
                    </ul>
                    <?php
                    }
