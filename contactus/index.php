...
<!-- main content -->
<section class="flex bg-[url('<?php echo $mainUrl; ?>assets/client/images/contact-us.jpg')] bg-center bg-cover h-[65vh] bg-[#294497] font-bold text-white">
<div class="container max-w-full mx-[10vw]">
