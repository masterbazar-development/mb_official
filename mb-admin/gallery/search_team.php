...
if (isset($_POST['searchcategory'])) {
   ...
   JOIN categories ON team.category = categories.id
      WHERE team.status != '2'  AND (team.filename LIKE '%$searchValue%' OR categories.name LIKE '%$searchValue%')";
...
?>
            <tr>
                ...
                <td><?= $item['filename'] ?></td>
                <td><img src="uploads/team/<?= $item['filename'] ?>" class="" width="80" height="80" alt=""></td>
                <td>
                    <?php
