                ...
                <div class="card-body">
                    <form action="../code" method="POST" enctype="multipart/form-data">
                        <div class="col-md-12 mb-3">
                            ...
                            if (isset($_GET['id'])) {
                                $teamid = $_GET['id'];
                                $category = "SELECT team.*, categories.name as category_name,categories.id as category_id
                                FROM team
                                JOIN categories ON team.category = categories.id
                                WHERE team.id='$teamid' LIMIT 1";
                        ...
                        <input type="hidden" name="id" value="<?= $row['id'] ?>">
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="submit" name="edit_add-team" onclick="uploadFiles()" class="btn btn-primary">Edit team</button>
                            </div>
                        </div>
                    </form>