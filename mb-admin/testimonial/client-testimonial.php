        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>ADD TESTIMONIALS
                        <a href="testimonial/view-testimonials" class="btn btn-danger float-end">Back</a>
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="../code.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="comment-head" class="form-control">
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="submit" name="testimonial_add" class="btn btn-primary">Add Client Testimonials</button>
                            </div>
                        </div>
                    </form>
                </div>
