                ...
                <div class="card-body">
                    <!-- <form action="code.php" method="POST">
                        <div class="col-md-8 mb-3">
                            <lable for="">Main Category</lable>
                            <textarea name="meta_description" class="form-control" rows="1" placeholder="Create Your main category Blogs/Gallery/FAQ"></textarea>
                        </div>
                        <div class="col-md-12 mb-3">
                            <button type="submit" name="main_category_add" class="btn btn-primary">Save Main Category</button>
                        </div>
                    </form> -->
                    <form action="code.php" method="POST">
                        <div class="row">
